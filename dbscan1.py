...
for z in Z:
    ...
    dataSet = loadDataSet('2021/2021-01-01-TESTMORE.csv', splitChar=',')
    C = dbscan(dataSet, 0.1, z)
    print(C)
    x = []
    y = []
    for data in dataSet:
    ...
    plt.title('DBSCAN %d' % z)
    plt.savefig('img/DBSCAN1-{}M.png'.format(z))
    plt.show()
    # print(x)
    # print(y)

    end = time.perf_counter()
    print(f'{z}运行时间：{end-start} s')